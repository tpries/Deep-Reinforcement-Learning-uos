...
def doStufF():
    for file in os.listdir(r"C:\Users\berit\Deep-Reinforcement-Learning-uos\Homework2\Tile Images"):
        ...
        cv2.circle(img, (x_middle, y_middle), 3, border_value, 0) # kreis

        cv2.imwrite(os.path.join(r"C:\Users\berit\Deep-Reinforcement-Learning-uos\Homework2\Tile Images",file[:-4]+"character.jpg"),img)
